<#include "header.ftl">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<a href="http://www.oracle.com/technetwork/java/javase/downloads/index.html"><img src="http://download.oracle.com/technetwork/java/get-java/getjavasesdk-120x30.png" alt="Get Java SE SDK" border="0" width="120" height="30" /></a>

			<br/>

			<a href="http://www.gentoo.org/"><img src="http://i2.wp.com/tuxtor.shekalug.org/wp-content/uploads/2015/08/gentoo-badge.png?fit=300%2C300" alt="Gentoo" style="border:0" /></a>
